        ...
        <>
                ...
                <div className='container-fluid'>
                    <div className='row justify-content-center align-items-end' style={{ height: "100dvh" }}>
                        ...
                        <div className='col-xl-4 text-center'>
                            <div className='display-3 text-white position-relative fw-semibold' style={{ marginBottom: "-50px", zIndex: "1" }}>Tamdyr Lezzetine <br /> Hoş geldiňiz</div>
            ...
            <div className='container pb-5  d-flex flex-column align-items-center '>
                ...
                <div className='row align-items-center justify-content-center mt-5'>
                    ...
                    <div className="col-xl-1 d-flex justify-content-center h-100">
                        <div className="star-icon">
                            <img src={starIcon} alt="" style={{ width: "1.5rem", height: "1.5rem" }} />
                        </div>
                    </div>
                    <div className='col-xl-5 text-white'>
                ...
                <div className='row align-items-center justify-content-center mt-5'>
                    ...
                    <div className='col-xl-5 position-relative'>
                        <img src={card2} alt="" className="img-fluid" style={{ borderRadius: "50% 50% 0 0", height: "650px", width: "500px", objectFit: "cover" }} />
                        <img src={card6} alt="" className='img-fluid position-absolute shadow' style={{ bottom: "7%", left: "55%", width: "450px", height: "280px", objectFit: "cover" }} />
                    </div>
                </div>
                <div className="star-icon">
                    <img src={starIcon} alt="" style={{ width: "1.5rem", height: "1.5rem" }} />
